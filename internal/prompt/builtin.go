...
var builtinTemplates = map[string]string{
	...
	"plan-review.md":     planReviewTemplate,
}
...
const planReviewTemplate = `# Plan Review: {{issue_title}}
...
- **Verify claims against reality.** If the research says "PostgreSQL does not support X" or "library Y cannot do Z," confirm it. Wrong factual claims in research propagate into wrong architecture.
